...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        $.ajax({
            type: 'post',
            url: '/TypingTestAdvanced/HandleShowUserProgess',
            dataType: "json",
    ...
    function getExerciseText() {
        $(document).ready(function () {
            $.ajax({
                type: 'post',
                url: '/TypingTestAdvanced/GetExerciseText',
                data: {
                    exerciseid: 2,
    ...
    function startTimer() {
        timerInterval = setInterval(function () {
            ...
            if (startTime <= 0) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/TypingTestAdvanced/HandleSaveResult',
                    data: {
                        sumword: totalWord,
